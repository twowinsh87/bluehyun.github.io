---
layout: post
title:  "[K8s]3장. 포드(pods)"
subtitle:   "[K8s]3장. 포드(pods)"
description : "[K8s]3장. 포드(pods)"
keywords : "msa, 쿠버네티스, 컨트롤 플레인, 포드, pods, pod, kuberenetes, kubectl get, 쿠버네티스란, 쿠버네티스 포드, 포드란?, k8s pod"
categories: etc
tags: k8s
comments: true
---
